...
for i = 1:numImages % Iterate over all images.
    ...
    nuc = (series1{1,1}/2+series1{4,1}/2+series1{7,1}/2+series1{10,1}/2+series1{13,1}/2); % Nuclei image
    if GAL8_CHANNEL
        gal8 = series1{GAL8_CHANNEL, 1};
        gal8TH = imtophat(gal8, SE_GAL8_TH);
    end
    if NP_CHANNEL
        uptake = (series1{3,1}/2+series1{6,1}/2+series1{9,1}/2+series1{12,1}/2+series1{15,1}/2);
